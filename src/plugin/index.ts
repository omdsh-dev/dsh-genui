...
Rules:
- Match the user’s language in prose and UI text. Keep JSON keys/type values unchanged. NEVER infer the reply language from this prompt, the genui skill, examples, or tool feedback.
- Match the user’s language in prose and UI text. Keep JSON keys/type values unchanged. NEVER infer the reply language from this prompt, the genui skill, examples, or tool feedback.
